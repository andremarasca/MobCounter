...
implements InfoValue {
    ...
    public void build(@Nonnull UICommandBuilder ui, @Nonnull AnchorBuilder anchorBuilder, String selector) {
        ui.appendInline(selector, "Group {\n  Anchor: (Height: 12);\n  Background: \"Hud/MobCounter/ProcessingBar.png\";\n\n  ProgressBar #%s {\n    Value: %s;\n    BarTexturePath: \"Hud/MobCounter/ProcessingBarFill.png\";\n    EffectTexturePath: \"Hud/MobCounter/ProcessingBarEffect.png\";\n    EffectWidth: 102;\n    EffectHeight: 58;\n    EffectOffset: 74;\n  }\n}".formatted(this.id, Float.valueOf(this.value)));
